                ...
                OptionGroup.createBuilder()
                    .add(
                        OptionImpl.createBuilder(boolean.class, storage)
                            ...
                            .setTooltip(
                                "Renders the 3D world at a lower internal resolution while keeping the GUI at native resolution.")
                    ...
                    .add(
                        OptionImpl.createBuilder(int.class, storage)
                            ...
                            .setTooltip(
                                "Controls the internal 3D world rendering resolution. Lower values improve performance but reduce image sharpness.")
                            .setControl(
                                option -> new SliderControl(option, 25, 100, 1, ControlValueFormatter.percentage()))
                            .setBinding(
